...
| --- | --- | ---: | ---: | ---: | --- |
| `code/src/Slugger.php` | `code/tests/SluggerTest.php` | 70% | 40% | 2 | Overall coverage looks acceptable, but most covered lines come from incidental tests. |
...
- `Slugger.php`: `minimum-coverage = 70%`, `matched-coverage = 40%`, `coverage-attribution = 3|2`.
